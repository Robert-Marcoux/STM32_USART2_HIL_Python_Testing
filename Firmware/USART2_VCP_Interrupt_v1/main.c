...
/* USART2 VCP with Interrupt — v1
 * Bare-metal USART2 echo over the Nucleo's Virtual COM Port, using
 * interrupt-driven RX (USART2_IRQHandler) instead of polling. The main
 * loop is intentionally empty. Baud rate derived live, same as the
 * polling version, for a fair comparison. See project README. */
